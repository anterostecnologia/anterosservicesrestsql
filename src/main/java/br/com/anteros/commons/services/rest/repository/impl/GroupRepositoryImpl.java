...
import br.com.anteros.commons.services.rest.repository.GroupRepository;
...
public class GroupRepositoryImpl extends GenericSQLRepository<Group, Long> implements GroupRepository {

	@Autowired
	public GroupRepositoryImpl(@Qualifier("sessionFactorySQL")SQLSessionFactory sessionFactory) {
