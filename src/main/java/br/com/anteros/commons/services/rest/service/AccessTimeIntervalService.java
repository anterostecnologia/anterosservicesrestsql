...
@ResourceSecured(resourceName = "AccessTimeInterval", description = "AccessTimeInterval")
public interface AccessTimeIntervalService extends SQLServiceSecured<AccessTimeInterval, Long> {
