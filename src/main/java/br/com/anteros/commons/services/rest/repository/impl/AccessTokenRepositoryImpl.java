...
import br.com.anteros.commons.services.rest.repository.AccessTokenRepository;
...
public class AccessTokenRepositoryImpl extends GenericSQLRepository<AccessToken, Long> implements AccessTokenRepository {
	...
	@Autowired
	public AccessTokenRepositoryImpl(@Qualifier("sessionFactorySQL")SQLSessionFactory sessionFactory) {
